...
class WP_Email_Template_Functions
{
	...
	public static function replace_shortcode_header ($template_html='', $email_heading='') {
		...
		$google_fonts[] = $wp_email_template_style_body['h1_font']['face'];
		$google_fonts[] = $wp_email_template_style_body['h2_font']['face'];
		$google_fonts[] = $wp_email_template_style_body['h3_font']['face'];
		$google_fonts[] = $wp_email_template_style_body['h4_font']['face'];
		$google_fonts[] = $wp_email_template_style_body['h5_font']['face'];
		$google_fonts[] = $wp_email_template_style_body['h6_font']['face'];
