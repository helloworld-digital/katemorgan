...
if( wp_email_template_check_pin() ){
	...
	add_filter('wp_mail', array('WP_Email_Template_Hook_Filter', 'check_exclude_subject_for_apply_template'), 19);
	...
	if ( version_compare( get_option( 'a3rev_wp_email_template_version'), '1.4.0' ) === -1 ) {
	...
	if ( version_compare( get_option( 'a3rev_wp_email_template_version'), '1.5.0' ) === -1 ) {
		update_option( 'a3rev_wp_email_template_version', '1.5.0' );

		include( WP_EMAIL_TEMPLATE_DIR. '/includes/updates/wp-email-update-1.5.0.php' );
	}
