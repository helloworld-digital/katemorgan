		...
		<tbody>
			...
			<tr id="general-settings">
				<td colspan="2" style="padding:0;">
					...
					<p class="description"><?php _e( 'Manage export options across Store Exporter Deluxe from this screen. Options are broken into sections for different export formats and methods. Click Save Changes to apply changes.', 'woo_ce' ); ?></p>
				</td>
			</tr>
			...
			<tr valign="top">
				...
				<td>
					...
					<p class="description"><?php _e( 'The filename of the exported export type. It is not neccesary to add the filename extension (e.g. .csv, .xml, .xls, .xlsx, etc.) as this is added at export time. Tags can be used: ', 'woo_ce' ); ?> <code>%dataset%</code>, <code>%date%</code>, <code>%time%</code>, <code>%store_name%</code>.</p>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<p class="warning"><?php _e( 'Warning: Saving sensitve export files (e.g. Customers, Orders, etc.) to the WordPress Media directory will make them accessible to the public without restriction.', 'woo_ce' ); ?></p>
					<p class="description"><?php _e( 'Save copies of exports to the WordPress Media for later downloading. By default this option is turned off.', 'woo_ce' ); ?></p>
				</td>
			</tr>
			<tr>
				<th>
...
<?php } ?>
			...
			<tr>
				...
				<td>
					...
					<p class="description"><?php _e( 'The field delimiter is the character separating each cell in your CSV. This is typically the \',\' (comma) character. To use the TAB character as the delimiter enter <code>TAB</code>. ', 'woo_ce' ); ?></p>
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<select id="line_ending" name="line_ending">
						<option value="windows"<?php selected( $line_ending_formatting, 'windows' ); ?>><?php _e( 'Windows', 'woo_ce' ); ?></option>
						<option value="mac"<?php selected( $line_ending_formatting, 'mac' ); ?>><?php _e( 'Mac' ,'woo_ce' ); ?></option>
						<option value="unix"<?php selected( $line_ending_formatting, 'unix' ); ?>><?php _e( 'Unix', 'woo_ce' ); ?></option>
					</select>
